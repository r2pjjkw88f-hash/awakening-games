...
**求救信号识别游戏** - 基于"父母的感受=孩子的求救信号"设计的觉察游戏。

通过5个受挫阶段（引起注意、权力斗争、报复心理、自暴自弃、最终沉默）帮助家长识别孩子的求救信号，理解行为背后的需求，游戏结束后生成专属觉察报告。

**情绪地图游戏** - 基于"父母的情绪是理解孩子的地图"设计的觉察游戏。

通过5种情绪场景（烦躁/恼火、愤怒/被挑衅、震惊/伤心、无助/迷茫、失望/心寒）帮助家长从自己的情绪出发，读懂孩子行为背后的真实需求，学习理解四步法（觉察情绪→解读信号→看见需求→回应需求），游戏结束后生成专属觉察报告。
...
│   │       ├── sos-game.tsx      # 求救信号识别游戏组件
│   │       └── emotion-game.tsx  # 情绪地图游戏组件
│   ├── hooks/              # 自定义 Hooks
